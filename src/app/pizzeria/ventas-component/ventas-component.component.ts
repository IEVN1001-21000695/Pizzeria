...
export class VentasComponent implements OnInit {
  formGroup!: FormGroup;
  toppingOptions = ['Peperoni', 'Piña', 'Champiñon'];
  sizeOptions = ['Pequeña', 'Mediana', 'Grande'];
  orders: PizzaOrder[] = [];
  ...
  private loadCurrentOrder() {
    ...
    if (orders) {
      ...
      this.formGroup.patchValue({
        ...
        toppings: {
          Peperoni: lastOrder.pedido.toppings.includes('Peperoni'),
          Piña: lastOrder.pedido.toppings.includes('Piña'),
          Champiñon: lastOrder.pedido.toppings.includes('Champiñon')
        },
